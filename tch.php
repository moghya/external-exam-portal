...
<head>
  	...
  	<body>
		...
		<div class="container">
	<ul class="list-group">
	<li class="list-group-item"><a href="ins_t.php">Insert new Record</a></li>
	<li class="list-group-item"><a href="mod_t.php">Modify existing Record</a></li>
	<li class="list-group-item"><a href="del_t.php">Delete a Record</a></li>
	<li class="list-group-item"><a href="get_t.php">Search a Record</a></li>
	</ul>
</html>
<?php
	}
